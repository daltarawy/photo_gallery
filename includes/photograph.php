...
class Photograph extends DatabaseObject {
    ...
    public function save() {
        ...
        if (isset($this -> id)) {
            ...
            $target_path = SITE_ROOT . DS . 'php' . DS . 'photo_gallery' . DS . 'public' . DS . $this -> upload_dir . DS . $this -> filename;
    ...
    public function comments() {
        $input = array('photograph_id' => $this -> id);

        return Comment::find_by_criteria_record($input);
    }
